    ...
    <c:forEach var="employee" items="${employees}">
        <tr>
            <form method="post" id="post ${employee.ID}">
                ...
                <td>
                    <input type="text" class="form-control" maxlength="512" placeholder="Enter login"
                           value="${employee.login}">
                </td>
                <td>
                    <input type="email" class="form-control" maxlength="512" aria-describedby="emailHelp"
                           placeholder="Enter email"
                           value=" ${employee.email}">
                </td>
                <td>
                    <input type="number" max="1000" class="form-control" placeholder="Enter rank"
                           value="${employee.rank}">
                </td>
                <td>
